...
//        api.moveTo(Move1, qMove1, true);
        ...
        Point Target2_1 = new Point(11.20535, -10.1, 5.460300);
        Quaternion qTarget2_1 = new Quaternion(0f, 0f, -0.707f, 0.707f) ;
        api.moveTo(Target2_1, qTarget2_1, true);
        /*Mat target2Mat = api.getMatNavCam();
        api.saveMatImage(target2Mat, "target2.jpeg");*/
        dealWithCenter(11.20535, -10.1, 5.460300,760,500,0.0008,1);
        api.laserControl(true);
...
if(xAb>minX && xAb < maxX && yAb > minY && yAb <maxY){
    ...
    private void dealWithCenter(double x,double y, double z,double xRef,double yRef,double kp,int numberTry){
