...
public class YourService extends KiboRpcService {
    ...
    public void testBoard(){
        ...
        Board board = Board.create(objP2, dict, board2ID);
    ...
    //		Imgproc.circle(processedImg, center, 4, new Scalar(0,255,255), -1);
            Calib3d.drawFrameAxes(processedImg,cameraMatrix,distCoeffs,b_rvec,b_rvec,(float)0.05);
    ...
    //		System.out.println(contours.size());
...

        {
            ...
            Imgproc.drawContours(cropped_img, contours, i, color, 1, Imgproc.LINE_8, hierarchey, 1, new Point());
        }
        ...
        String output_file = "C:\\Users\\Elyes\\Desktop\\Kibo-2022\\OUTPUT\\processedImg.jpeg";
            Imgcodecs.imwrite(output_file,processedImg);
        output_file ="C:\\Users\\Elyes\\Desktop\\Kibo-2022\\OUTPUT\\warped_img.jpeg";
            Imgcodecs.imwrite(output_file,warped_img);
        output_file ="C:\\Users\\Elyes\\Desktop\\Kibo-2022\\OUTPUT\\cropped_img.jpeg";
            Imgcodecs.imwrite(output_file,cropped_img);
        output_file ="C:\\Users\\Elyes\\Desktop\\Kibo-2022\\OUTPUT\\binaryImg.jpeg";
            Imgcodecs.imwrite(output_file,binaryImg);
}
    ...
    private static org.opencv.core.Point[] sortingPoints(MatOfPoint pts, int x, int y) {
...
//		    2-------3
    ...
    public void find_paper(Mat img, List<org.opencv.core.Point> src_pts) {
